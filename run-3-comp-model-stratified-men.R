...
arrows(0.009,80,0.038,80,angle=90,code=3,length=0.02)
arrows(0.002,60,0.025,60,angle=90,code=3,length=0.02, col=3)
arrows(0.029,40,0.088,40,angle=90,code=3,length=0.02, col=4)
points(0.018,80,pch=16) # men aged 16-24 reporting 0 new partners
points(0.008, 60, pch=16, col=3) # men aged 16-24 reporting 1 new partner
points(0.051, 40, pch=16, col=4) # men aged 16-24 reporting 2+ new partners
...
cs <- contourLines(foi[1,], scr[,1], t(positivity), 
                   levels=c(0.023, 0.126, 0.017, 0.090, 0.045, 0.137))
